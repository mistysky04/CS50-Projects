//User inputs rearranged alphabet to act as cipher key, program prompts user for plaintext, outputs ciphertext created by substituting letters with given key
